...
fun tlvParser(data: String, map: HashMap<Int, String>) {
    val tagList = setOf("8A", "89", "91", "71","72" ,"9F26", "9F10", "9F37", "9F36", "95", "9A", "9C", "9F02", "5F2A", "9F1A", "82",
            "5F34", "9F27", "9F33", "9F34", "9F35", "9F03", "9F47","9F06","9F22","DF05","DF06","DF02","DF03","DF04")
    var pointer = 0
    fun reader() {
 ...
 * */
fun addPad(input: Int, padChar: String, totalLen: Int, toLeft: Boolean = true): String = addPad(input.toString(), padChar, totalLen, toLeft)
